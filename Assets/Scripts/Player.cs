...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    private void HandleMovement()
    {
        ...
        /* Even if inputVector is (0, 0) (indicating no movement), moveDir becomes (0, 0, 0) but 
          transform.forward remains as it was last set. This is because Slerp smoothly 
          interpolates between two vectors (current forward direction and desired direction) 
          and doesn't reset to zero unless instructed to do so.*/
    }
